...
$diterima = $db->query("SELECT * FROM formulir WHERE parent = 1");
$dt = $db->query("SELECT COUNT(parent) AS jumlah_siswa FROM formulir WHERE parent = 1");
	...
	<div class="col-lg-12">
		<h2 class="page-header">Data Siswa Diterima</h2>
			<div class="panel panel-default">
				<div class="panel-heading">Data Siswa Yang Sudah Diterima</div>
				<!-- /.panel-heading -->
					<div class="panel-body">
						<table width="100%" class="table table-striped table-bordered table-hover" id="DataTables-Example">
							...
							<tbody>
								...
								while($data=$diterima->fetch(PDO::FETCH_ASSOC)) {                     
		                            $nisn = $data['nisn'];
